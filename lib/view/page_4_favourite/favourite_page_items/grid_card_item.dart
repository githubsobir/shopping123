                    ...
                    children: [
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            ...
                            errorBuilder: (context, error, stackTrace) =>
                              ...
                              child: Image.asset(
                                  height: 160, "assets/images/shopping1.png"),
                            ),
                          ),
                        ),
                      ),
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ref.read(setFavourite2.notifier).updateFavorite(
                                 widget.resultModelNotifier.id.toString());
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("${widget.resultModelNotifier.product.price} \$",
