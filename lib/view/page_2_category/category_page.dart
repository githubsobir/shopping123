...
class _CategoryPageState extends ConsumerState<CategoryPage> {
  ...
  Widget bodyBuild() {
    var data = ref.watch(getCategoryData1);

    if (data.boolDownload.toString() == "0") {
      /// Loading
      return Center(
    ...
    } else if (data.boolDownload.toString() == "1") {
      /// success
      return Container(
          color: Colors.white,
          child: SingleChildScrollView(
            ...
            ListView.builder(
              ...
              //attention
              padding:
                  const EdgeInsets.only(left: 13.0, right: 13.0, bottom: 13.0),
              shrinkWrap: true,
                ...
                return Column(children: [
                  ...
                  data.results[index].subcategories.isNotEmpty
                      ? ExpansionTile(
                          ...
                          children: [
                            data.results[index].subcategories.isNotEmpty
                                ? ListView.builder(
                                    itemCount: data
                                        .results[index].subcategories.length,
                                    shrinkWrap: true,
                                    physics:
                                ...
                                : ListTile(
                                    ...
                                    onTap: () {
                                      getAction(
                                        categoryId:
                                            data.results[index].id.toString(),
                                        parentId: data.results[index].parent
                                            .toString(),
                                        categoryName:
                      ...
                      : ListTile(
                          onTap: () {
                            getAction(
                              categoryId: data.results[index].id.toString(),
                              parentId: data.results[index].parent.toString(),
                              categoryName: data.results[index].name.toString(),
                            );
                          },
                          leading: Text(data.results[index].name,
                              style: const TextStyle(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              MaterialButton(
                onPressed: () {
                  ref.read(getCategoryData1.notifier).getDataCategory();
                },
