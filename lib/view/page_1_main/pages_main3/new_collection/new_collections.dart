            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Visibility(
                    visible:
                    getData.results[index].rating == -1 ? true : false,
                    child: SizedBox(
                      height: 30,
                      child: Row(children: [
                        Icon(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    if (getData.results[index].isCart) {
                                      ...
                                      ref.read(boolHideNavBar.notifier).state =
                                      true;
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            MaterialButton(
              onPressed: () {
                ref.read(setFavourite2.notifier).getData(modelSearch: ModelSearch(page: "1"));
              },
              color: Colors.blue.shade800,
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8)),
              child:
              Text("tryAgain".tr(), style: const TextStyle(color: Colors.white)),
            )
          ],
        ),
      );
