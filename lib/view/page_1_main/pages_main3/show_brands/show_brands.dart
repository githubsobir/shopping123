  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Form(
          ...
          child: SafeArea(
            child: getBrandProduct.results.isNotEmpty
                ? GridView.builder(
                    shrinkWrap: true,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      getBrandProduct.results[index].name
                                          .toString(),
                                      maxLines: 2,
                                  ...
                                  Visibility(
                                    visible:
                                        getBrandProduct.results[index].rating ==
                                                -1
                                            ? true
                                            : false,
                                    child: SizedBox(
